...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Fetch de productos desde el archivo JSON local
    async function obtenerProductos() {
        try {
    ...
    function cargarProductos1(productosParaCargar = productos) {
        contenedorProductos.innerHTML = ''; // Limpia el contenedor antes de agregar nuevos productos
    ...
    // Inicializa la obtención de productos
    obtenerProductos();
});
